...
?>
			<div class="col">
				...
				No other company offers as complete a technology product such as Laptop de Marne la Vallee. We provide infrastructure and business offerings that span from handheld devices to some of the world's most powerful supercomputer distribution. We offer consumers a wide range of products and services from Laptop to accessories and from computing to home printing. This comprehensive portfolio helps us match the right products, services and solutions to our customers' specific needs.</p>
				<p>Are you searching for additional information? Please contact us:</p>
				<address>University Institutes for Technology of Marne la Vallée<br>
				2 Rue Albert Einstein<br>
				Champs-sur-marne<br>
				contact: <a href="mailto:laptopmlv@gmail.com">laptopmlv@gmail.com</a><br>
				</address>
			</div>

			<div class="col">
				<h3>John WAN KUT KAI: Co-Founder</h3>
				<p>John WAN KUT KAI is the co-founder of Laptop de Marne la Vallee ©, a website project for the University Institutes for Technology. Laptop de Marne la Vallee has been named a must-read site by the DUT info 1 and is ranked as the most influential media outlet.
